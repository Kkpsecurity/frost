...
return [
    ...
    */
    ...
    'right_sidebar_scrollbar_auto_hide' => 'l', // 'l' = always visible, 'leave' = auto-hide on scroll
    'right_sidebar_width' => '500px', // Custom width - doubled from default 250px
    ...
    */
    ...
    'menu' => [
        ...
        // Control Sidebar Toggle (Communication Panel)
        [
            'text' => '',
