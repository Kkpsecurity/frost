...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Register Twilio notification service
        $this->app->singleton(\App\Services\TwilioNotificationService::class, function ($app) {
            return new \App\Services\TwilioNotificationService();
        });
    }
