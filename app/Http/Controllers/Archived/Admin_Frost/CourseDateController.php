...
class CourseDateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.admin-center.course-dates.index', compact('content'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.admin-center.course-dates.create', compact('content'));
    }
    ...
    public function show(CourseDate $courseDate)
    {
        ...
        return view('admin.admin-center.course-dates.show', compact('content'));
    }
    ...
    public function edit(CourseDate $courseDate)
    {
        ...
        return view('admin.admin-center.course-dates.edit', compact('content'));
    }
