...
namespace App\Classes\Students\Certificates;

use Auth;

use Fpdf\Fpdf;

use App\Classes\Students\Certificates\CertificateBodyTrait;
use App\Classes\Students\Certificates\CertificateHelpersTrait;
