...
class AdminLteConfigElements {
    ...
    {
        return ['right_sidebar_icon' => $this->settingHelper->get('right_sidebar_icon', 'fas fa-comments')];
    }
    ...
    {
        return ['right_sidebar_push' => $this->settingHelper->get('right_sidebar_push', false)];
    }
