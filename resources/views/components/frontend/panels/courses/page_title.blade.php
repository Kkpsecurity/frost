        ...
        <div>
            <div class="course-badge-large mb-2">
                ...
                @if ($course['popular'] ?? false)
                    <span class="badge bg-warning text-dark ms-2">{{ __('frontend.courses.most_popular') }}</span>
                @endif
            </div>
    ...
    <div class="course-meta-details row g-3 p-3 rounded"
        ...
        <div class="col-md-3 col-sm-6">
            <div class="meta-item text-center">
                ...
                <div class="meta-label text-white-50">{{ __('frontend.courses.duration_label') }}</div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="meta-item text-center">
                ...
                <div class="meta-label text-white-50">{{ __('frontend.courses.format_label') }}</div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="meta-item text-center">
                ...
                <div class="meta-label text-white-50">{{ __('frontend.courses.certification_label') }}</div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="meta-item text-center">
                ...
                <div class="meta-label text-white-50">{{ __('frontend.courses.class_size_label') }}</div>
