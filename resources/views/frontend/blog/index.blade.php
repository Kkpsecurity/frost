{{-- Blog Index Page Following Template Theme --}}
<x-frontend.site.site-wrapper :title="'Security Training Blog - Expert Insights & Updates - ' . config('app.name')">
    <x-slot:head>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-12 text-center">
                    ...
                    <h5 class="text-white-50">Stay informed with the latest in security training, gun laws, and weapons safety</h5>
                ...
                <div class="col-lg-10">
                    ...
                    @else
                        ...
                        <div class="text-center py-5">
                            <h3 class="text-white">No blog posts available</h3>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (newsletterForm) {
                newsletterForm.addEventListener('submit', function(e) {
                    ...
                    alert('Thank you for subscribing! You\'ll receive updates on security training and gun law changes.');
                    this.reset();
                });
            }
