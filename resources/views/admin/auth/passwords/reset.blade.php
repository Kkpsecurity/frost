...
@php
    $passwordResetUrl = route('admin.password.update');
...
@section('auth_body')
    <p class="login-box-msg">Enter your new admin password</p>

    <form action="{{ $passwordResetUrl }}" method="post">
        @csrf
        ...
        <div class="input-group mb-3">
            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                value="{{ $email ?? old('email') }}" placeholder="Admin Email" required>
