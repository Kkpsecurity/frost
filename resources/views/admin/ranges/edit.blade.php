...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Edit Range</h1>
        <a href="{{ route('admin.ranges.show', $content['range']) }}" class="btn btn-secondary">
...
<div class="container-fluid">
    <form action="{{ route('admin.ranges.update', $content['range']) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   id="name"
                                   name="name"
                                   value="{{ old('name', $content['range']->name) }}"
                                   required>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   id="city"
                                   name="city"
                                   value="{{ old('city', $content['range']->city) }}"
                                   required>
                            @error('city')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   id="address"
                                   name="address"
                                   value="{{ old('address', $content['range']->address) }}"
                                   required>
                            @error('address')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number"
                                               ...
                                               step="0.01"
                                               min="0"
                                               value="{{ old('price', $content['range']->price) }}"
                                               required>
                                        @error('price')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="times"
                                           name="times"
                                           value="{{ old('times', $content['range']->times) }}"
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox"
                                       ...
                                       name="appt_only"
                                       value="1"
                                       {{ old('appt_only', $content['range']->appt_only) ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox"
                                       ...
                                       name="is_active"
                                       value="1"
                                       {{ old('is_active', $content['range']->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   id="inst_name"
                                   name="inst_name"
                                   value="{{ old('inst_name', $content['range']->inst_name) }}"
                                   required>
                            @error('inst_name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="email"
                                   ...
                                   id="inst_email"
                                   name="inst_email"
                                   value="{{ old('inst_email', $content['range']->inst_email) }}">
                            @error('inst_email')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   id="inst_phone"
                                   name="inst_phone"
                                   value="{{ old('inst_phone', $content['range']->inst_phone) }}"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('range_html') is-invalid @enderror"
                                      id="range_html"
                                      name="range_html"
                                      rows="8">{{ old('range_html', $content['range']->range_html) }}</textarea>
                            @error('range_html')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
