<form action="{{ route('admin.center.adminusers.update', [$user->id, $tab_id]) }}" enctype="multipart/form-data" method="POST" id="{{ $tab_id }}-form">
    @csrf
                                    ...
                                    <div class="part_input mt-30 lbel25">
                                        <div class="input-group">
                                            <div class="custom-file center aligned">
                                                <a href="{{ route('admin.center.adminusers.delete', [$user->id, $tab_id]) }}" class="btn btn-danger btn-block">
