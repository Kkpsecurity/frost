                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h3 class="card-title"><i class="fa fa-users"></i> {{ __('Admin Users Management') }}</h3>
                                </div>
                                <div class="col-lg-6">
                                    <div class="float-right">
                                        @if(request()->segment(4))
                                            <a href="{{ route('admin.center.adminusers') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> {{ __('Back') }}</a>
                                        @else
                                            <a href="{{ route('admin.center.adminusers', ['create']) }}" class="btn btn-primary"><i class="fa fa-plus"></i> {{ __('Add Admin User') }}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
...
@php
   ...
   $deleteRecord = Form::open([
        'route' => [
            'admin.center.adminusers', 'delete'
        ], 
        'method' => 'DELETE', 
