                    ...
                    <div class="card-body">
                                            ...
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    @foreach ($settings as $key => $value)
                                                        @php
                                                            $fullKey =
                                                                $prefix === 'general' ? $key : $prefix . '.' . $key;
                                                            $displayValue =
                                                                is_array($value) || is_object($value)
                                                                    ? json_encode($value)
                                                                    : $value;
                                                            $displayValue =
                                                                strlen($displayValue) > 50
                                                                    ? substr($displayValue, 0, 50) . '...'
                                                                    : $displayValue;
                                                        @endphp
                                                        <tr>
                                                            <td><code>{{ $key }}</code></td>
                                                            ...
                                                            <td>
                                                                <div class="btn-group btn-group-sm">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('admin.settings.destroy', $fullKey) }}"
                        ...
                        @else
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle"></i> No settings found. <a
                                    href="{{ route('admin.settings.create') }}">Create your first setting</a>.
                            </div>
                        @endif
                    </div>
                </div>
