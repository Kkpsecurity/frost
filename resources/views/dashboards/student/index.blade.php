    ...
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        {{-- Debug: Check if studentData is available --}}
                        @if(isset($studentData))
                            {{-- Debug output --}}
                            <script>
                                console.log('🔍 Student Data Available:', true);
                                console.log('🔍 ID Verification Summary:', @json($studentData['validations']['summary'] ?? null));
                            </script>
                        @else
                            <script>
                                console.log('❌ Student Data NOT Available in blade template');
                            </script>
                        @endif

                        <div id="face-verification-container"
                             data-student-id="{{ Auth::user()->id }}"
                             data-student-name="{{ Auth::user()->fname }} {{ Auth::user()->lname }}"
                             data-verification-data="{{ json_encode($studentData['validations']['summary'] ?? null) }}">
                            {{-- React Face Verification Component will be mounted here --}}
                        </div>
                    </div>
                </div>
...
@section('scripts')
    {{-- Include Student React App for Face Verification --}}
