<style>
    /* Truncated text style - keeping this for specific functionality */
    .truncated-text {
        display: -webkit-box;
        -webkit-line-clamp: 3;
    ...
    /* Full text on hover */
    .support-services:hover .truncated-text {
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-12 text-center">
                ...
                <h5 class="text-white-50">Before enrolling in our weapons license course, here's what you need to know
                    and prepare:</h5>
            </div>
        </div>
...
<script>
    ...
    servicesData.forEach(service => {
        ...
        serviceDiv.innerHTML = `
            <div class="support-services service-item d-flex">
                <span class="top-icon"><i class="${service.icon}"></i></span>
                <span class="support-images">
