...
-color: var(--frost-light-primary-color) !important;
}

/* Override default FullCalendar backgrounds */
.fc .fc-view-harness,
.fc .fc-daygrid,
.fc .fc-daygrid-body,
.fc .fc-scroller,
.fc .fc-scroller-liquid-absolute {
    background-color: var(--frost-light-primary-color) !important;
}
...
.fc-header-toolbar .fc-button {
    ...
    border: 1px solid var(--frost-secondary-color);
    color: var(--frost-white-color);
    font-weight: 500;
    padding: 8px 16px;
    border-radius: 4px;
...
.fc-header-toolbar .fc-button:focus {
    box-shadow: 0 0 0 2px rgba(23, 170, 201, 0.3);
}

.fc-header-toolbar .fc-button.fc-button-active {
    background-color: var(--frost-highlight-color);
