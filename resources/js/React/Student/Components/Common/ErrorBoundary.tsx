...
/**
 * StudentErrorBoundary - Catches React component errors
 *
 * Wraps the entire Student Portal app
...
> {
    ...
    componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
        console.error("❌ Error caught by StudentErrorBoundary:", error, errorInfo);
        this.setState({
            error,
            errorInfo,
        });
