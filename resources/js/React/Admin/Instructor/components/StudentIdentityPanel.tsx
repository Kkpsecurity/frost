...
const StudentIdentityPanel: React.FC<StudentIdentityPanelProps> = ({
    ...
    const { data, isLoading, error } = useQuery<IdentityData>({
    ...
    const approveIdCardMutation = useMutation({
        ...
        onSuccess: (result) => {
            console.log(
                "✅ ID card approved:",
                result?.message || "ID card approved successfully!",
            );
    ...
    const approveHeadshotMutation = useMutation({
        ...
        onSuccess: (result) => {
            console.log(
                "✅ Headshot approved:",
                result?.message || "Headshot approved successfully!",
            );
    ...
    const declineIdCardMutation = useMutation({
        ...
        onError: (error: any) => {
            alert(
                error?.response?.data?.message || "Failed to decline ID card",
            );
        },
    });
    ...
    const declineHeadshotMutation = useMutation({
        ...
        onError: (error: any) => {
            alert(
                error?.response?.data?.message || "Failed to decline headshot",
            );
        },
    });
                    ...
                    <div className="alert alert-danger">
                        <p className="mb-0">
                            {(error as any)?.message ||
                                "Failed to load student identity data"}
                        </p>
                    </div>
            ...
            <div className="card bg-dark text-light border-warning h-100">
                ...
                <div className="card-body">
                    <div className="alert alert-warning">
                        ...
                        <p className="mb-0">
                            {data?.student.name} has not yet uploaded their ID
                            card or headshot for verification.
                        </p>
                    </div>
                    <div className="mt-3">
                        <p>
            ...
            >
                                            ...
                                            <div className="col-6">
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        if (
                                                            confirm(
                                                                "Approve this ID card?",
                                                            )
                                                        ) {
                                                            approveIdCardMutation.mutate(
                                                                idcard.validation_id!,
                                                            );
                                                        }
                                                    }}
                                            ...
                                            <div className="col-6">
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        if (
                                                            confirm(
                                                                "Approve this headshot?",
                                                            )
                                                        ) {
                                                            approveHeadshotMutation.mutate(
                                                                headshot.validation_id!,
                                                            );
                                                        }
                                                    }}
                ...
                {data.fully_verified && (
                    <div className="alert alert-success mb-3">
                        ...
                        <strong>Student identity fully verified</strong> - Both
                        ID card and headshot have been approved.
                    </div>
                )}
                        ...
                        <div className="modal-content bg-dark text-light">
                            ...
                            <div className="modal-body">
                                <div className="alert alert-info">
                                    ...
                                    Declining will reject this photo and
                                    automatically request a new one from the
                                    student.
                                </div>
                                <div className="mb-3">
