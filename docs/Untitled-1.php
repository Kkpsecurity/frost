                    ...
                    <nav aria-label="Media Manager breadcrumb">
                        <ol class="breadcrumb breadcrumb-sm mb-0" id="mediaBreadcrumb">
                            <li class="breadcrumb-item">
                                ...
                                <span id="currentDiskBreadcrumb">Public Storage</span>
                            </li>
                            <li class="breadcrumb-item">
                                <i class="fas fa-folder mr-1 text-muted"></i>
                                <span id="currentFolderBreadcrumb">media</span>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page" id="currentPathBreadcrumb">
                                <i class="fas fa-location-arrow mr-1 text-primary"></i>
                                <span id="currentLocationText">root</span>
                            </li>
                        </ol>
                    </nav>
                </div>
